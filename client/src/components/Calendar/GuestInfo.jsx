      ...
      <div class="flex-col justify-start items-start gap-[9px] inline-flex">
        <div class="justify-start items-start gap-1 inline-flex">
          <div class="w-[179px] flex-col justify-start items-start gap-1 inline-flex">
            ...
            <div class="w-[47px] h-[15px] text-sky-700 text-xs font-medium font-['Kumbh Sans']">3 Adults</div>
          </div>
        ...
        <div class="flex-col justify-start items-start gap-[18px] flex">
          <div class="justify-start items-start gap-[7px] inline-flex">
            <div class="w-[104px] h-8 px-[15px] py-2.5 bg-sky-700 rounded-[30px] justify-center items-center gap-2.5 flex">
              <div class="w-[86px] text-center text-white text-[10px] font-semibold font-['Kumbh Sans']">Check In</div>
            </div>
