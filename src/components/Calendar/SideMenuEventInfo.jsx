  ...
  return (
    <div className={`flex flex-col w-[272px] h-auto font-['Kumbh Sans'] rounded-l-[25px] bg-white`} >
      <div className='flex flex-col pl-[26px] py-[30px]'>
        <div className="text-stone-900 text-xl font-bold">{event.title}</div>
        <div className="text-stone-900 text-[10px] font-normal pb-[14px]">{date.month} {date.day}, {date.year} @ {event.start_time}</div>
